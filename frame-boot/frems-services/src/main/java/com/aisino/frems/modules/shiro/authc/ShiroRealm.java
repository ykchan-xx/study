package com.aisino.frems.modules.shiro.authc;//String cacheTokenpackage com.aisino.frems.modulesshiro.authc;
...
public class ShiroRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken auth) throws AuthenticationException {
		...
		if (token == null) {
			log.info("————————身份认证失败——————————IP地址:  "+ oConvertUtils.getIpAddrByRequest(AppContext.getRequest()));
	...
	public boolean jwtTokenRefresh(String token, String userName, String passWord) {
		...
		String cacheToken="11";
		if (LangUtil.isNotEmpty(cacheToken)) {
			// 校验token有效性
