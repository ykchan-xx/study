...
public class CommonController {
	...
	public InvokeResult upload(HttpServletRequest request, HttpServletResponse response, HttpServletRequest req) {
		...
		try {
			...
			return InvokeResult.success("上传成功", "data:image/jpeg;base64," + Base64.encode(mf.getBytes()));
		} catch (IOException e) {
