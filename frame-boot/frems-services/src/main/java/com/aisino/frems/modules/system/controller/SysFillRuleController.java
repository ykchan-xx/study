...
import com.aisino.frems.modules.system.entity.SysFillRule;
...
import com.aisino.frems.common.util.FillRuleUtil;
import com.aisino.frems.modules.system.service.ISysFillRuleService;
...
public class SysFillRuleController {
    ...
    public InvokeResult queryPageList(SysFillRule sysFillRule,
    ...
    public InvokeResult testFillRule(@RequestParam("ruleCode") String ruleCode) {
    ...
    public InvokeResult add(@RequestBody SysFillRule sysFillRule) {
    ...
    public InvokeResult edit(@RequestBody SysFillRule sysFillRule) {
    ...
    public InvokeResult deleteBatch(@RequestParam(name = "ids", required = true) String ids) {
        ...
        return InvokeResult.success("批量删除成功！");
    }
    ...
    public InvokeResult queryById(@RequestParam(name = "id", required = true) String id) {
        ...
        return InvokeResult.success(null, sysFillRule);
    }
    ...
    public InvokeResult executeByRuleCode(@PathVariable("ruleCode") String ruleCode, @RequestBody JSONObject formData) {
    ...
    public InvokeResult executeByRuleCodeBatch(@RequestBody JSONObject ruleData) {
        ...
        return InvokeResult.success(null, results);
    }
