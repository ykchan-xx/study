...
public class JeecgDataAutorUtils {
	...
	public static synchronized List<SysPermissionDataRuleModel> loadDataSearchConditon() {
		return (List<SysPermissionDataRuleModel>) AppContext.getRequest().getAttribute(MENU_DATA_AUTHOR_RULES);
	...
	public static synchronized String loadDataSearchConditonSQLString() {
		return (String) AppContext.getRequest().getAttribute(MENU_DATA_AUTHOR_RULE_SQL);
	}
	...
	public static synchronized SysUserCacheInfo loadUserInfo() {
		return (SysUserCacheInfo) AppContext.getRequest().getAttribute(SYS_USER_INFO);
