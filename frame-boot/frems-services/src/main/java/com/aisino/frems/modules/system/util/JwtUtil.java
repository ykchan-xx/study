package com.aisino.frems.modules.system.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws AsRuntimeException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws AsRuntimeException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (LangUtil.isEmpty(username)) {
			throw new AsRuntimeException("未获取到用户");
		}
		return username;
	}
	...
	public static String getSessionData(String key) {
		...
		if (LangUtil.isNotEmpty(key)) {
			HttpSession session = AppContext.getRequest().getSession();
