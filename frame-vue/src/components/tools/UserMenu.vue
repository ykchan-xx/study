<template>
  <div class="user-wrapper" :class="theme">
    ...
    &lt;!&ndash; update-end author:sunjianlei date:20191@20 for: 解决全局样式冲突的问题 &ndash;&gt;
    &lt;!&ndash; update_end  author:zhaoxin date:20191129 for: 做头部菜单栏导航 &ndash;&gt;
    <span class="action">
   ...
   <!-- <header-notice class="action"/>-->
    <a-dropdown>
      <span class="action action-full ant-dropdown-link user-dropdown-menu">
        ...
        <span v-if="isDesktop()">{{ nickname() }}（{{ userInfo().username }}）</span>
      </span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /* update_end author:zhaoxin date:20191129 for: 做头部菜单栏导航*/
      ...mapActions(["Logout"]),
      ...mapGetters(["nickname", "sysUsername", "avatar","userInfo"]),
      getAvatar(){
