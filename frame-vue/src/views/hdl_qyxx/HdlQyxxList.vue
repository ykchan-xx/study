<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="签约方">
              <a-input placeholder="请输入签约方" v-model="queryParam.qyf"></a-input>
            </a-form-item>
          </a-col>
          </template>
          <a-col :md="6" :sm="8" >
    ...
    <!-- 表单区域 -->
    <HdlQyxx-modal ref="modalForm" @ok="modalFormOk"></HdlQyxx-modal>
  </a-card>
</template>

<script>
  import HdlQyxxModal from './modules/HdlQyxxModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/qygl/hdl_qyxx/listPage",
          delete: "/qygl/hdl_qyxx/deleteById",
          deleteBatch: "/qygl/hdl_qyxx/deleteBatchByIds",
        },
      }
    },
    computed: {},
