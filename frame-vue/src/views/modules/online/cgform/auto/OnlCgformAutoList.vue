    ...
    methods: {
      ...
      initAutoList(){
        ...
        getAction(`${this.url.getColumns}${this.code}`).then((res)=>{
          ...
          if(res.success){
            if(res.data.checkboxFlag == 'Y'){
              this.checkboxFlag = true
            }else{
              this.checkboxFlag = false
            }

            if(res.data.paginationFlag=='Y'){
      ...
      getQueryParams() {
        ...
        param['page.pageNo'] = this.table.pagination.current;
        param['page.pageSize'] = this.table.pagination.pageSize;
