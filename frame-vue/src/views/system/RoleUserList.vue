    ...
    <a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          ...
          <a-button @click="handleAdd" type="primary" icon="delete" style="margin-left: 8px">清空</a-button>
  ...
  export default {
    ...
    methods: {
      ...
      getQueryParams2() {
        ...
        param['page.pageNo'] = this.ipagination2.current
        param['page.pageSize'] = this.ipagination2.pageSize
      ...
      loadData2(arg) {
        ...
        getAction(this.url.list2, params).then((res) => {
          if (res.success) {
            this.dataSource2 = res.data.records
